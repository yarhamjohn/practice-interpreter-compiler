...
class TestCalc6Interpreter(unittest.TestCase):
    ...
    def test_parentheses_two(self):
        interpreter = Interpreter(Lexer("7 + 3 * (10 / (12 / (3 + 1) - 1)) / (2 + 3) - 5 - 3 + (8)"))
        self.assertEqual(interpreter.expr(), 10)

    def test_parentheses_three(self):
